...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Concept Chef" },
      { name: "description", content: "One video or document, a complete learning workspace." },
      { property: "og:title", content: "Concept Chef" },
      { property: "og:description", content: "One video or document, a complete learning workspace." },
